...
def __virtual__():
    ...
    '''
    return 'urbackup_group_setting' if 'urbackup.set_group_setting' in __salt__ else False
...
def present(
    ...
    setting = __salt__['urbackup.get_group_setting'](groupname, name)
    ...
    if not setting:
        ...
        ok = __salt__['urbackup.set_group_setting'](groupname, name, value)
